...
<div class="expert-message">
	...
	<div class="triangle">
		<Triangle color={colors.background}/>
	</div>
	<div class="bubble" style={`color: ${colors.text}; background-color: ${colors.background};`}>
		<div class="name" style={`color: ${colors.primary}`}>Master Expert</div>
